...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('show_hidden_files', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('default_sort_by', sa.String(length=50), nullable=False, server_default='name'),
        sa.Column('default_sort_order', sa.String(length=50), nullable=False, server_default='asc'),
        sa.Column('items_per_page', sa.Integer(), nullable=False, server_default='100'),
