...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('role', postgresql.ENUM('admin', 'operator', 'viewer', name='userrole'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('active', 'suspended', 'pending', name='workerstatus'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('type', postgresql.ENUM('copy', 'move', 'delete', 'mkdir', name='operationtype'), nullable=False),
        sa.Column('source_path', sa.Text(), nullable=False),
        sa.Column('dest_path', sa.Text(), nullable=True),
        sa.Column('status', postgresql.ENUM('pending', 'in_progress', 'completed', 'failed', 'rolled_back', name='operationstatus'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('worker_status', postgresql.ENUM('pending', 'in_progress', 'completed', 'failed', 'rolled_back', name='operationstatus'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('type', postgresql.ENUM('string', 'int', 'json', 'boolean', name='configtype'), nullable=False),
